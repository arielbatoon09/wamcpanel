...
export function InputGroupAddon({ className, align = "block-end", ...props }: React.ComponentProps<"div"> & { align?: "block-start" | "block-end" }) {
  return (
    <div
      data-slot="input-group-addon"
      data-align={align}
      className={cn("absolute right-3 flex items-center justify-center", align === "block-start" ? "top-3" : "top-1/2 -translate-y-1/2", className)}
      {...props}
    />
  );
}
