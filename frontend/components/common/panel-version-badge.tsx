...
import { UpdatesModal } from "@/components/features/settings/updates-modal";
    ...
    <div className="flex items-center gap-2 select-none">
      {status.updateAvailable ? (
        <UpdatesModal>
          <button
            type="button"
            className="group flex items-center gap-1.5 rounded-lg border border-amber-500/20 bg-amber-500/5 px-3 py-1.5 font-mono text-[10px] font-semibold text-amber-500 transition-all hover:bg-amber-500/10 active:scale-95 cursor-pointer"
          >
      ...
      <UpdatesModal>
        <button
          type="button"
          className="flex items-center gap-1.5 rounded-lg border border-border bg-secondary/15 px-3 py-1.5 font-mono text-[10px] text-muted-foreground hover:bg-secondary/25 transition-all active:scale-95 cursor-pointer"
        >
